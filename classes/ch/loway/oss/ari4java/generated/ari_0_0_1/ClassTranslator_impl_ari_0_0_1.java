package ch.loway.oss.ari4java.generated.ari_0_0_1;
...
import ch.loway.oss.ari4java.generated.ari_0_0_1.actions.*;

/**********************************************************
 * This is a class translator.
 *********************************************************/
public class ClassTranslator_impl_ari_0_0_1 implements ARI.ClassFactory {

  @Override
  public Class getImplementationFor(Class interfaceClass) { 

	if ( interfaceClass.equals(ActionApplications.class) ) {
	   return (ActionApplications_impl_ari_0_0_1.class);
	} else 

	if ( interfaceClass.equals(ActionAsterisk.class) ) {
	   return (ActionAsterisk_impl_ari_0_0_1.class);
	} else 
