...
public class ActionBridges_impl_ari_1_5_0 extends BaseAriAction  implements ActionBridges {
/**********************************************************
 * Active bridges
 * 
...
String json = httpActionSync();
return deserializeJson( json, Bridge_impl_ari_1_5_0.class ); 
}

@Override
public void create(String type, String bridgeId, String name, AriCallback<Bridge> callback) {
buildCreate(type, bridgeId, name);
httpActionAsync(callback, Bridge_impl_ari_1_5_0.class);
}
