...
public class ClassTranslator_impl_ari_1_7_0 implements ARI.ClassFactory {
  ...
  public Class getImplementationFor(Class interfaceClass) { 
	...
	if ( interfaceClass.equals(ChannelStateChange.class) ) {
	   return (ChannelStateChange_impl_ari_1_7_0.class);
	} else 

	if ( interfaceClass.equals(ChannelTalkingFinished.class) ) {
	   return (ChannelTalkingFinished_impl_ari_1_7_0.class);
	} else 
