...
public class ActionChannels_impl_ari_2_0_0 extends BaseAriAction  implements ActionChannels {
/**********************************************************
 * Active channels
 * 
...
return deserializeJsonAsAbstractList( json,
   new TypeReference<List<Channel_impl_ari_2_0_0>>() {} ); 
}

@Override
public void list(AriCallback<List<Channel>> callback) {
buildList();
httpActionAsync(callback, new TypeReference<List<Channel_impl_ari_2_0_0>>() {});
}
...
String json = httpActionSync();
return deserializeJson( json, Channel_impl_ari_2_0_0.class ); 
}
...
buildOriginate(endpoint, extension, context, priority, label, app, appArgs, callerId, timeout, variables, channelId, otherChannelId, originator, formats);
httpActionAsync(callback, Channel_impl_ari_2_0_0.class);
}
