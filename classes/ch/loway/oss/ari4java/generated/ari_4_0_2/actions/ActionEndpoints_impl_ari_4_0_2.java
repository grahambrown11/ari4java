...
public class ActionEndpoints_impl_ari_4_0_2 extends BaseAriAction  implements ActionEndpoints {
/**********************************************************
 * Asterisk endpoints
 * 
 * List all endpoints.
...
return deserializeJsonAsAbstractList( json,
   new TypeReference<List<Endpoint_impl_ari_4_0_2>>() {} ); 
}

@Override
public void list(AriCallback<List<Endpoint>> callback) {
buildList();
httpActionAsync(callback, new TypeReference<List<Endpoint_impl_ari_4_0_2>>() {});
}
...
String json = httpActionSync();
return deserializeJson( json, Endpoint_impl_ari_4_0_2.class ); 
}

@Override
public void get(String tech, String resource, AriCallback<Endpoint> callback) {
buildGet(tech, resource);
httpActionAsync(callback, Endpoint_impl_ari_4_0_2.class);
}
