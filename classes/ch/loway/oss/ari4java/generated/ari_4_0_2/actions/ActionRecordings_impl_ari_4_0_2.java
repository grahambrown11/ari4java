...
public class ActionRecordings_impl_ari_4_0_2 extends BaseAriAction  implements ActionRecordings {
/**********************************************************
...
return deserializeJsonAsAbstractList( json,
   new TypeReference<List<StoredRecording_impl_ari_4_0_2>>() {} ); 
}

@Override
public void listStored(AriCallback<List<StoredRecording>> callback) {
buildListStored();
httpActionAsync(callback, new TypeReference<List<StoredRecording_impl_ari_4_0_2>>() {});
}
...
String json = httpActionSync();
return deserializeJson( json, StoredRecording_impl_ari_4_0_2.class ); 
}

@Override
public void getStored(String recordingName, AriCallback<StoredRecording> callback) {
buildGetStored(recordingName);
httpActionAsync(callback, StoredRecording_impl_ari_4_0_2.class);
}
 ...
 *********************************************************/
private void buildGetStoredFile(String recordingName) {
reset();
url = "/recordings/stored/" + recordingName + "/file";
method = "GET";
lE.add( HttpResponse.build( 403, "The recording file could not be opened") );
lE.add( HttpResponse.build( 404, "Recording not found") );
}

@Override
public byte[] getStoredFile(String recordingName) throws RestException {
buildGetStoredFile(recordingName);
String json = httpActionSync();
return deserializeJson( json, byte[].class ); 
}

@Override
public void getStoredFile(String recordingName, AriCallback<byte[]> callback) {
buildGetStoredFile(recordingName);
httpActionAsync(callback, byte[].class);
}
